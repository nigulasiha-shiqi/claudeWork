      ...
      return (
        ...
        >
          ...
          <button
            ...
            className="absolute -top-7 -right-2 translate-x-1/2 -translate-y-1/2 w-4 h-4 bg-red-500 hover:bg-red-600 text-white text-xs rounded-full flex items-center justify-center transition-colors duration-200"
            title="删除变量"
          >
            ×
          </button>
